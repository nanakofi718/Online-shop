namespace Ordering.Application.Orders.Commands.UpdateOrder
{
        ...
        : ICommandHandler<UpdateOrderCommand, UpdateOrderResult>
    {
        public async Task<UpdateOrderResult> Handle(UpdateOrderCommand command, CancellationToken cancellationToken)
        {
            ...
            // TODO: Update order properties from command.Order here
            UpdateOrdersWithNewValues(order, command.Order);
        ...
        private void UpdateOrdersWithNewValues(Order order, OrderDto orderDto)
        {
            ...
            var UpdatedPayment = Payment.Of(orderDto.Payment.CardName, orderDto.Payment.CardNumber, orderDto.Payment.Cvv, orderDto.Payment.Expiration, orderDto.Payment.PaymentMethod);
